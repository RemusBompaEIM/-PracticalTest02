...
public class BitCoinInformation {
    ...
    public BitCoinInformation(String date_last_update, String val_bitcoin) {
    ...
    public void setVal_bitcoin(String val_bitcoin) {
        this.val_bitcoin = val_bitcoin;
    }

    private String date_last_update;
    private String val_bitcoin;
